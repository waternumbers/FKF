...
This example shows how to fit an ARMA(2, 1) model using this Kalman filter
implementation (see also stats' makeARIMA and KalmanRun).
...
## Note that Zt and Tt have no third dimension but HHt and GGt do in the call below.
## This will cause memory errors unless check.input is set to TRUE
